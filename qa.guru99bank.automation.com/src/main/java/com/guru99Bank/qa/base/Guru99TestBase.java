...
public class Guru99TestBase {
	...
	public Guru99TestBase() {
		try {
			file = new FileInputStream("C:\\selenium\\Pom\\PageObjectModel-master\\qa.guru99bank.automation.com\\src\\main\\java\\com\\guru99Bank\\qa\\config\\Guru99Bank.properties");
			prop = new Properties();
			prop.load(file);
