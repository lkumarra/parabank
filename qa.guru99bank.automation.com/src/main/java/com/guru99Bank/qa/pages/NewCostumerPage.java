...
public class NewCostumerPage extends Guru99TestBase{
	 ...
	 */
	public void addNewCostumer(String costumerName, String gender, String dob, String address, String city, String state, String pin, String mobileNumber, String email, String password) {
